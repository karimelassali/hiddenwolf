...
export default function Home() {
  ...
  return (
    ...
    <div 
    style={{backgroundImage:generateRandomBackground(), backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}
  ...
  className="relative z-10 flex flex-col items-center justify-center gap-12 p-8 backdrop-blur-md bg-white/5 rounded-3xl border border-white/10 shadow-2xl max-w-md w-full mx-4">
    ...
    <div className="text-center space-y-4">
      ...
      <h1 className="text-3xl font-bold text-white mb-2">Ready to Play , {user?.firstName}?</h1>
      <p className="text-gray-300 text-sm">Create a new room or join an existing one</p>
    </div>
