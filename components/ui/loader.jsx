  ...
  return (
    <div className="flex items-center gap-2">
      <motion.div
        ...
        className="h-4 w-4 rounded-full border border-violet-300 bg-gradient-to-b from-violet-400 to-violet-300" />
      <motion.div
        initial={{
          y: 0,
        }}
  ...
  return (
    <div className="flex items-center">
      <motion.div
        ...
        className="h-4 w-4 rounded-full bg-white shadow-md dark:bg-white" />
      <motion.div
        initial={{
          x: 0,
        }}
        ...
        className="h-4 w-4 -translate-x-2 rounded-full bg-white shadow-md dark:bg-white" />
      <motion.div
        initial={{
          x: 0,
        }}
        ...
        className="h-4 w-4 -translate-x-4 rounded-full bg-white shadow-md dark:bg-white" />
    </div>
  );
};
